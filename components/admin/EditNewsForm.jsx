...
const EditNewsEditor = dynamic(() => import("./EditNewsEditor"), {
  ssr: false,
});

export default function EditNewsForm({ onClose, data, reload }) {
  const [editorState, setEditorState] = useState(
    EditorState.createWithContent(convertFromRaw(JSON.parse(data.body)))
  );
  ...
  const submitNews = () => {
    ...
    setLoading(true);
    axios
      .post("/static/editnews.php", formdata, {
        headers: {
